...
- **ch.admin.bit.jeap.jme:jme-spring-boot-integration-test**: 5.9.0 → 5.11.0 (minor)
...
### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 37.6.0 → 38.0.1 (major)
...
- Update jeap-spring-boot-parent to 37.2.0
...
### Added
- S3 connection
- Basic file api with monitoring and logging
